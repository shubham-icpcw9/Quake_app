...
public class EarthquakeActivity extends AppCompatActivity implements LoaderCallbacks<List<Location>> {
    ...
    private static final String USGS_REQUEST_URL =
            "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&eventtype=earthquake" +
                    "&orderby=time&minmag=3&limit=20";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new EarthquakeAdapter(getApplicationContext(), new LinkedList<Location>());
        ...
        earthquakeListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Location currentEarthquake = adapter.getItem(position);
    ...
    @Override
    public void onLoadFinished(Loader<List<Location>> loader, List<Location> earthquakes) {
    ...
    private static class EarthquakeLoader extends AsyncTaskLoader<List<Location>> {
        ...
        public List<Location> loadInBackground() {
            ...
            List<Location> earthquakes = QueryUtils. extractEarthquakes(mUrl);
            return earthquakes;
        }
